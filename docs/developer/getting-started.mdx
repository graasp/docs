...
You should now have yarn eabled with your version of node defined by nvm.

This opperation should be repeated every time you update the version of node you use.
